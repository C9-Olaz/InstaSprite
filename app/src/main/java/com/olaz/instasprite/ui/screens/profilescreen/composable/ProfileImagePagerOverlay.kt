...
//    onSaveImage: (ISpriteData, String) -> Unit = { _, _ -> }
//) {
...
//
//    Log.d("ImagePagerOverlay", "currentSprite: $currentSprite")
//
//    if (showDeleteDialog && currentSprite != null) {
//        DeleteSpriteConfirmDialog(
//            spriteName = currentSprite.meta?.spriteName ?: "Untitled",
//            onConfirm = {
//                onSpriteDelete(currentSprite.sprite.id)
...
//    }
//
//    if (showSaveImageDialog && currentSprite != null) {
//        SaveImageDialog(
//            spriteName = currentSprite.meta?.spriteName ?: "Untitled",
//            iSpriteData = currentSprite.sprite,
//            onSave = { sprite, fileName ->
...
//                    showDeleteOption = isCurrentUserOwner
//                )
//            },
//            bottomBar = {
//                BottomBar(
...
//                            onSpriteEdit(currentSprite.sprite)
//                        }
//                    },
//                    onSaveImageTap = { showSaveImageDialog = true },
//                    isCurrentOwner = isCurrentUserOwner,
...
//
//    val spriteName = metadata?.spriteName ?: "Untitled"
//    val dateCreated = metadata?.createdAt?.toDateString() ?: "Unknown"
//    val dateModified = metadata?.lastModifiedAt?.toDateString() ?: "Unknown"
//
...
//            } else {
//                Text(text = "Name: $spriteName")
//                Text(text = "Date posted: $dateCreated")
//                Text(text = "Last modified: $dateModified")
//                Text(text = "Dimensions: $spriteWidth x $spriteHeight")
//
//                Spacer(modifier = Modifier.height(12.dp))
...
//            }
//
//            // Only show more options menu if user is owner
//            if (showDeleteOption) {
//                Box {
//                    IconButton(
...
//}
//
//// Simplified SaveImageDialog component without ViewModel dependency
//@Composable
//private fun SaveImageDialog(
//    spriteName: String,
//    iSpriteData: ISpriteData,
//    onSave: (ISpriteData, String) -> Unit,
//    onDismiss: () -> Unit
//) {
