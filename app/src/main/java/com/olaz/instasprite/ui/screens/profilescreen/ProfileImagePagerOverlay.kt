...
import com.olaz.instasprite.ui.screens.profilescreen.dialog.SaveImageDialog
...
fun ProfileImagePagerOverlay(
    ...
    isCurrentUserOwner: Boolean = false, // Add this parameter
        ...
        Scaffold(
            ...
            topBar = {
                TopBar(
                    ...
                    showDeleteOption = isCurrentUserOwner // Pass owner check
                )
            },
            bottomBar = {
                BottomBar(
...
private fun TopBar(
    ...
    showDeleteOption: Boolean = false // Add this parameter
) {
